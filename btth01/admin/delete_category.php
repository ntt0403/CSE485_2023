...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="delete_category.php?ma_tloai=<?php echo $ma_tloai ?>" method="post">
            <div class="mb-3">
                <label for="ma_tloai" class="form-label">Mã thể loại</label>
                <input type="number" class="form-control" name="ma_tloai" value="<?php echo $delete['ma_tloai']; ?>" readonly>
            </div>
            <div class="mb-3">
                <label for="ten_tloai" class="form-label">Tên thể loại</label>
                <input type="text" class="form-control" name="ten_tloai" value="<?php echo $delete['ten_tloai']; ?>" required>
            </div>
