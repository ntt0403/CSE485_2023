...
insert into baiviet (ma_bviet, tieude, ten_bhat, ma_tloai, tomtat, ma_tgia, ngayviet)
values (
2, 'Cảm ơn em đã rời xa anh', 'Vết mưa', 
2,
...
insert into baiviet (ma_bviet, tieude, ten_bhat, ma_tloai, tomtat, ma_tgia, ngayviet)
values (
3,'Cuộc đời có mấy ngày mai?', 'Phôi pha', 
2,
...
insert into baiviet (ma_bviet, tieude, ten_bhat, ma_tloai, tomtat, ma_tgia, ngayviet)
values (
6,'Hard Rock Hallelujah', 'Hard Rock Hallelujah', 
7,
...
insert into baiviet (ma_bviet, tieude, ten_bhat, ma_tloai, tomtat, ma_tgia, ngayviet)
values (
7, 'The Unforgiven', 'The Unforgiven', 
7,
...
insert into baiviet (ma_bviet, tieude, ten_bhat, ma_tloai, tomtat, ma_tgia, ngayviet)
values (
8, 'Nơi tình yêu bắt đầu', 'Nơi tình yêu bắt đầu', 
1,
...
insert into baiviet (ma_bviet, tieude, ten_bhat, ma_tloai, tomtat, ma_tgia, ngayviet)
values (
9, 'Love Me Like There’s No Tomorrow', 'Love Me Like There’s No Tomorrow', 
8,
...
values (
11, 
'Ôi Cuộc Sống Mến Thương', 'Ôi Cuộc Sống Mến Thương', 
5,
...
insert into baiviet (ma_bviet, tieude, ten_bhat, ma_tloai, tomtat, ma_tgia, ngayviet)
values (
13,'Như một cách tạ ơn đời', 'Người thầy', 
2,
